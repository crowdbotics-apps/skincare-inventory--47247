"""
Django settings for skincare_inventory__47247 project.
...
ROOT_URLCONF = 'skincare_inventory__47247.urls'
...
WSGI_APPLICATION = 'skincare_inventory__47247.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "skincare_inventory__47247 API",
    "DESCRIPTION": "API documentation for skincare_inventory__47247 App",
    "VERSION": "v1",
}
